...
compare-mysql:
	tmux new-session  -d /bin/sh -c 'make benchmarks/mysql/pgo-thin-fdoipra.regprof3'  \; \
		 split-window -h /bin/sh -c 'make BUILD_PATH=/home/riple/IPRA-exp/tmp2 benchmarks/mysql/pgo-thin-bfdoipra.regprof3' \; attach
